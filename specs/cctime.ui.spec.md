...
Столбцы фиксированы: время (56px, sticky left) + 7 дней (Пн–Вс) × N кабинетов. Первая строка — названия дней недели (каждый span = количество кабинетов). Вторая строка — заголовки кабинетов.
...
- маленькую метку даты (дд.мм) для идентификации недели
- имя специалиста
- имя клиента
